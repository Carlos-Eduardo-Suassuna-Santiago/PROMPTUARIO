"""
Configurações do Django para o projeto Promptuario.
Sistema de prontuário eletrônico para unidades de saúde pública.
"""
...
MIDDLEWARE = [
    ...
    'accounts.middleware.AccessLogMiddleware',  # LGPD - Log de Acesso
...
SITE_NAME = env('SITE_NAME', default='Promptuario')
SITE_URL = env('SITE_URL', default='http://localhost:8000')

# Appointment Settings
APPOINTMENT_CANCELLATION_HOURS = 24  # Horas mínimas para cancelamento
APPOINTMENT_DURATION_MINUTES = 30  # Duração padrão de consulta

# Backup Settings
BACKUP_INTERVAL_DAYS = 7  # Backup a cada 7 dias
